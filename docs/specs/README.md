...
| 2026-09-25 | [The watched screen](2026-09-25-the-watched-screen.md) — what is watched is the screen and what is operated is a sheet: one layout for the phone, the 696×793 window and the desktop in three tiers; the gauge (bar left, label over value right), the row's middle as a list with `scrap 1/16` as the one cost grammar, chipped rows receded, the cards' seat above the bottom bar, the sheen at 6s (#62 #91 #84) |
